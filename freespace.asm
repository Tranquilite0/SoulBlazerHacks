...
; Probably best to make sure there is space in this for additional COP routines since the COP jump table is restricted to in-bank jumps.
...
; There isnt much free space in bank 1, so it should be used sparingly since the text engine can only do table lookups in this bank.
!Bank01FreeSpaceStart = $01FE40
!Bank01FreespaceEnd   = $01FFFF

; Much of the core game logic and text is here.
!Bank02FreeSpaceStart = $02F740
!Bank02FreespaceEnd   = $02FFFF

; NPC Scripts/text for Acts 1 and 2 are in this bank.
; Also contains NPC scripts for the ending.
!Bank03FreeSpaceStart = $03F200
!Bank03FreespaceEnd   = $03FFFF

; NPC Scripts/text for Acts 4, 5 and 6 are in this bank.
!Bank04FreeSpaceStart = $04FAD3
!Bank04FreespaceEnd   = $04FFFF

;Unsure what is in this bank, but it has a decent amount of free space.
!Bank1EFreeSpaceStart = $1EF970
!Bank1EFreespaceEnd   = $1EFFFF

; NPC Scripts/text for Act 3 are in this bank.
