...
endstruct
    ...
    dw !Soul,            $0000 : !NPC_SoulOfMagician = $3C
    dw !Soul,            $0001 : !NPC_SoulOfLight = $3D
    dw !Soul,            $0002 : !NPC_SoulOfShield = $3E
    dw !Soul,            $0003 : !NPC_SoulOfDetection = $3F
    dw !Soul,            $0004 : !NPC_SoulOfReality = $40
